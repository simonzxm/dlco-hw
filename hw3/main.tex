...
\begin{equation}
    Z = \overline{\overline{\overline{I_0} \cdot \overline{I_1} \cdot \overline{I_2} \cdot \overline{I_3} \cdot \overline{I_4} \cdot \overline{I_5} \cdot \overline{I_6} \cdot \overline{I_7}}}
\end{equation}
...
\begin{figure}[h]
    ...
    \begin{circuitikz}
        ...
        \node[nand port, number inputs=8] (nandZ) at (9,-9.5) {};
        \node[not gate US, draw] (notZ) at (10.5,-9.5) {};
        \draw (nandZ.out) -- (notZ.input);
        \draw (notZ.output) -- (11.5,-9.5) node[right] {$Z$};
        \foreach \n [count=\i] in {0,...,7} {
            \draw (not\n.output) |- node[dot]{} (nandZ.in \i);
        }
    \end{circuitikz}
    \caption{与非门电路图}
\end{figure}
